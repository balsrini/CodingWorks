...
//		System.out.println(solve(new ArrayList<Integer>(Arrays.asList( 1,2,3,5,7))));
	  ...
	  public static int solve(ArrayList<Integer> A) {
		  ...
		  for(int i=0;i<N;i++)
		  {
			  largestSum += (A.get(i)%pow * Math.pow(2, i)%pow)%pow;
			  smallestSum += (A.get(N-i-1)%pow * Math.pow(2, i)%pow)%pow;
		  }
		   return (int)((((largestSum - smallestSum)%pow) + pow)%pow);
